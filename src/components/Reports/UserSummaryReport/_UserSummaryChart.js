        ...
        <div>
            {
                ...
                >
                    ...
                    <XAxis type="number" />
                    <YAxis dataKey="userName" type="category" width={160}>
                    ...
                    <Bar dataKey="estHour" fill="#82ca9d" name="Est. Hour">
                        <LabelList dataKey="estHour" position="insideRight" />
                    </Bar>
                    
                    <Bar dataKey="officeHour" fill="#8884d8" name="Office Hour">
                        {/* <LabelList dataKey="officeHour" position="right" /> */}
                    </Bar>

                    <Bar dataKey="myCount" fill="#FFBB28" name="Task">
                        <LabelList dataKey="myCount" position="insideRight" />
                    </Bar>
